...
#### 2.2.4 DLC、サブプロジェクト、およびパッチは簡単に維持できます
...
### 2.6 `Assets`または` AssetTypes`という名前のフォルダを作成しないこと ![#](https://img.shields.io/badge/lint-supported-green.svg)
...
すべてのblueprintsは、警告及びエラー無しの状態で、コンパイルする必要があります。 非常に恐ろしい予期しない動作に急速にカスケードするので、blueprintsの警告とエラーを直ちに修正する必要があります。
